...
const totalDaysPracticing = yearsPracticing * 365;
console.log("Total days practicing: " + totalDaysPracticing);

const remainingDays = (10 - yearsPracticing) * 365;
console.log("Remaining days to 10-year milestone: " + remainingDays);

const percentageCompleted = (yearsPracticing / 10) * 100;
console.log("Percentage of milestone completed: " + percentageCompleted + "%");

const cumulativeDays = totalDaysPracticing * 1; // Assuming 1 hour of practice per day
console.log("Cumulative days spent practicing: " + cumulativeDays);