...
//console.log ('welcome $ {name}, good to see yuo again!');
}

const malePersonOne = "James";
const femalePersonOne = "Jeddy";
const femalePersonTwo = "Tanya";

// --^-- write your code here --^--
greet (malePersonOne);
greet (femalePersonOne);
greet (femalePersonTwo);
