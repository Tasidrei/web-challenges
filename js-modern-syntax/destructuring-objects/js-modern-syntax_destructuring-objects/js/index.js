...
// console.log(`Name: ${name}, Course: ${course}, Location: ${location}`);
...
console.log(`Dog: ${dogName}, Breed: ${dogBreed}, Age: ${dogAge}`);
...
console.log(`Last Name: ${personLastName}, More Information:`, moreInformation);
