...
*/
const startingBalance = 1000; // Initial savings balance
const monthlyContribution = 200; // Amount saved each month
const months = 12; // Number of months to track savings

// Calculate total savings after the specified number of months
