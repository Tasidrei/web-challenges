...
// We should avoid using IDs, instead use data attribute "data-js". 
// Thus, we remove ("#next") and put ('[data-js="next-button"]') instead
...
// The listner is not executed, because, the ("prev") command is not recognised or known by JS. 
// We should use "click" instead like "Onclick" for HTML.
...
//  the "log" was missing at the "console.log" command
...
// because both have the exact command. The first one will overrwite the second in this case. Thus, to see the second one react, 
// we could change the ".remove" to ".add" 
